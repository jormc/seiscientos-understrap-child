...
function seiscientos_list_section_pages_shortcode_function( $atts ){
	return seiscientos_list_section_pages();
}
add_shortcode( 'seiscientos_home_sections', 'seiscientos_list_section_pages_shortcode_function' );
...
function seiscientos_list_section_pages( $args = '' ) {
	...
	// All pages, so you must filter them...
...
add_shortcode('seiscientos_breadcrumbs', 'seiscientos_breadcrumbs');
*/
